...
export const Page = ({ user, onLogin, onLogout, onCreateAccount }) => (
  <article>
    <Header onCreateAccount={onCreateAccount} onLogin={onLogin} onLogout={onLogout} user={user} />
    ...
    <section>
      ...
      <p>
        ...
        <a href={'https://www.learnstorybook.com'} rel={'noopener noreferrer'} target={'_blank'}>
          {'Learn Storybook'}
        </a>
        {'. Read more in the'}{' '}
